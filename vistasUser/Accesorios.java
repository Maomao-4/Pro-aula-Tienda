...
public class Accesorios extends javax.swing.JFrame {
    ...
    public Accesorios() {
        ...
        setUndecorated(true);
        initComponents();
        JButton[] btns = {Hombre, Carrito, Mujer, Instagram, Instagram1, Niño, Twitter, Home,addC1,addC2,addC3,Sig,back, Filtrar, NoFil};
    ...
    private void initComponents() {
        ...
        Nombre.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/sun-glasses-.png"))); // NOI18N
        Nombre.setText("ACCESORIOS");
        Fondo.add(Nombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(592, 20, -1, -1));
        ...
        Fondo.add(LDown, new org.netbeans.lib.awtextra.AbsoluteConstraints(249, 96, 940, -1));
        ...
        Accesorios.setBackground(new java.awt.Color(153, 153, 255));
        ...
        Accesorios.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(233, 212, 181), 3));
                ...
                .addGroup(Menu1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(Menu1Layout.createSequentialGroup()
                        ...
                        .addGroup(Menu1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addComponent(Bienvenido2, javax.swing.GroupLayout.Alignment.LEADING)))
                    .addGroup(Menu1Layout.createSequentialGroup()
                        .addGap(36, 36, 36)
                        .addGroup(Menu1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        IconoBuscar1.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        IconoBuscar1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/magnifying-glass.png"))); // NOI18N
        Fondo.add(IconoBuscar1, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 120, 40, 40));
        ...
        filtro.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Anillo", "Collar", "Gargantilla", "Reloj", "Pulsera", " " }));
    ...
    private void FiltrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_FiltrarActionPerformed
        ...
        try {
            ...
            String consultaIDs = "SELECT etiqueta FROM Productos WHERE tipo = 'Accesorios' AND Nombre LIKE '%" + filtroa + "%'";
    ...
    public void ConsultaIDs() {
        try {
            // Recupera la lista de etiquetas de productos con tipo "Mujer"
            String consultaIDs = "SELECT etiqueta FROM Productos WHERE tipo = 'Accesorios'";
            ResultSet resultadoIDs = co.consultar(consultaIDs);
            while (resultadoIDs.next()) {
                int etiqueta = resultadoIDs.getInt("etiqueta");
                idArray.add(etiqueta);
